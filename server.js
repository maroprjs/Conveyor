...
udpdserver1.on('message', function (message, remote) {
	...
	if(ioSocket){
                //console.log("inside socket");
		ioSocket.emit('status_report',message.toString());
	}
});
